...
** (2018-present) Distric0x (https://district0x.io)
*** Roles: Developer
...
* Side projects and opensource contributions
  - Clograms, Clojure[Script] source code diagrams [[https://github.com/jpmonettas/clograms][Clograms]]
  - Clindex, a Clojure[Script] source file indexer. [[https://github.com/jpmonettas/clindex][Clindex]]
  - Create magic sheets to improve your Clojure[Script] repl experience ([[https://github.com/jpmonettas/magic-sheet][Magic Sheet]])
  - Static clojurescipt source code analyzer. Index and explore various aspects of your clojurescript projects ([[https://github.com/jpmonettas/re-mount-module-browser][Re-mount module browser]])
  - Visualize and explore your solidity smart contracts ([[https://github.com/jpmonettas/smart-view][Smart View]])
  ...
  - A reagent component for laying out tree nodes in 2D space. [[https://github.com/jpmonettas/reagent-flowgraph][reagent-flowgraph]]
  - A library for laying out tree nodes in 2D space for Clojure and ClojureScript. [[https://github.com/jpmonettas/clj-tree-layout][clj-tree-layout]]
  ...
  - Macros for debugging and understanding clojure code flow. [[https://github.com/jpmonettas/xray][xray]]
